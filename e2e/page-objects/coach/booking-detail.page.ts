...
export class CoachBookingDetailPage extends BasePage {
  ...
  get bookingStatus() { return this.page.locator('[data-slot="badge"]', { hasText: /confirmed|pending|cancelled/i }) }
  get clientName() { return this.page.getByText(/booking.*owner|client/i).first() }

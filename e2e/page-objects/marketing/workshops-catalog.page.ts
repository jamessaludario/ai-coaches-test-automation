...
import { waitForCardsToRefresh } from '../../helpers/form.helper'
...
export class WorkshopsCatalogPage {
  ...
  async clickFirstLearnMore() {
    const learnMoreLinks = this.page.getByRole('link', { name: workshopScheduleContent.learnMoreButton })
